...
PROGRESS_FILE = DATA_DIR / "v11_progress.json"
FAILED_FILE = DATA_DIR / "v11_failed_symbols.txt"

SCAN_FILE = DATA_DIR / "level1000_v11_scan.csv"
TOP_FILE = DATA_DIR / "level1000_v11_top.csv"
LATEST_FILE = DATA_DIR / "level1000_v11_latest.csv"
MODEL_FILE = DATA_DIR / "level1000_v11_model_metrics.csv"
...
def collect_data(symbols):
    ...
    print()
    print("=" * 78)
    print(" LEVEL 1000 V11 VERİ MOTORU")
    print("=" * 78)
...
def walk_forward_validation(
    ...
    print()
    print("=" * 78)
    print(" V11 WALK-FORWARD VALIDATION")
    print("=" * 78)
...
def run_predictions(
    ...
    print()
    print("=" * 78)
    print(" LEVEL 1000 V11 AI TAHMİN")
    print("=" * 78)
