...
PROGRESS_FILE = DATA_DIR / "v12_progress.json"
FAILED_FILE = DATA_DIR / "v12_failed_symbols.txt"

SCAN_FILE = DATA_DIR / "level1000_v12_scan.csv"
TOP_FILE = DATA_DIR / "level1000_v12_top.csv"
LATEST_FILE = DATA_DIR / "level1000_v12_latest.csv"
MODEL_FILE = DATA_DIR / "level1000_v12_model_metrics.csv"
...
EXPECTED_RETURN_CANDIDATES = 1000

EXPECTED_RETURN_LOW = -0.25
...
def collect_data(symbols):
    ...
    print()
    print("=" * 78)
    print(" LEVEL 1000 V12 VERİ MOTORU")
    print("=" * 78)
    ...
    print(
        "[CACHE] Mevcut cache kullanılacak."
    )

    print(
        "[CACHE] V12 gerektiğinde 5 yıllık veri tamamlayacak."
    )
    ...
    def _cache_job(symbol):
        return symbol, load_cache(symbol)
...
def walk_forward_validation(
    ...
    print()
    print("=" * 78)
    print(" V12 WALK-FORWARD VALIDATION")
    print("=" * 78)
    ...
    if len(unique_dates) >= 3:
        ...
        for i in range(
            ...
            train_years = unique_dates[:i]
            test_year = unique_dates[i]
    ...
    # ========================================================
    # FIX:
    # isinstance() ikinci argümanında bütün tipler
    # TEK TUPLE içinde verilmelidir.
    # ========================================================
...
def run_predictions(
    ...
    print()
    print("=" * 78)
    print(" LEVEL 1000 V12 AI TAHMİN")
    print("=" * 78)
